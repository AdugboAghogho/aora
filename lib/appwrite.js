...
export const appwriteConfig = {
    ...
    bookmarkCollectionId: '67ae1d6500264f4ecf31',
};
...
//         appwriteConfig.databaseId, // Use the correct database ID from config
//         appwriteConfig.videoCollectionId, // Replace with your actual bookmarks collection ID
//         [Query.equal("isBookmarked", true)] // Assuming "isBookmarked" is a field marking saved videos
//       );
  
//       return response.documents; // Return the list of bookmarked videos
//     } catch (error) {
...
//   import { databases } from "./appwriteConfig"; // Ensure you import the configured Appwrite instance

  const DATABASE_ID = "67845479000f3b9d916a"
  const COLLECTION_ID = "67ae1d6500264f4ecf31"
